    ...
    <header class="sticky top-0 z-40 bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-slate-200">
      <div class="container mx-auto px-4 py-3 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <img src="https://cdn.builder.io/api/v1/image/assets%2F01577c1cf32546459d931bd87d36ba97%2F95ab5d90f15f413681559542011ba792?format=webp&width=128" alt="BroBot AI logo" class="h-9 w-9 rounded-lg shadow ring-2 ring-brand-200"/>
          <div>
