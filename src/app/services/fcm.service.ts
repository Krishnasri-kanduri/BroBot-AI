  ...
  async ensureToken(): Promise<string | null> {
            ...
            try {
              Push.addListener("registration", async (data: any) => {
                ...
                if (t) {
                  ...
                  this.toast.show(
                    "Push enabled",
                    "You will receive reminder alerts.",
                    "success",
                  );
                }
                resolve(t);
              ...
              Push.addListener("pushNotificationReceived", (notif: any) => {
                const title =
                  notif?.title || notif?.notification?.title || "Reminder";
                const body =
                  notif?.body || notif?.notification?.body || "It's time.";
    ...
    try {
      ...
      if (token) {
        ...
        this.toast.show(
          "Push enabled",
          "You will receive reminder alerts even when closed.",
          "success",
        );
